...
class TestPrettySize(unittest.TestCase):
    ...
    def test_3MB_verbose(self):
        self.assertEqual(sjutils.pretty_size(self.size_3MB, verbose = True), "3.0 MegaBytes")
    ...
    def test_4YB_verbose(self):
        self.assertEqual(sjutils.pretty_size(self.size_4YB, verbose = True), "4 YottaBytes")
